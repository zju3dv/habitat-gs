...
class RenderCamera : public MagnumCamera {
 public:
  ...
  /**
   * @brief Set active render target and Gaussian Splatting state for custom
   * drawables.
   */
  ...
  RenderTarget* getRenderTarget() const { return renderTarget_; }

  void setGaussianSplattingShader(GaussianSplattingShader* shader) {
    gaussianShader_ = shader;
  }

  GaussianSplattingShader* getGaussianSplattingShader() const {
    return gaussianShader_;
  }

  void setGaussianTime(float time) { gaussianTime_ = time; }
  ...
  std::pair<float, float> getDepthRange() const {
    return {nearPlane_, farPlane_};
  }

  void resetRenderState() {
    renderTarget_ = nullptr;
    gaussianShader_ = nullptr;
  }
 ...
 protected:
  ...
  GaussianSplattingShader* gaussianShader_ = nullptr;
