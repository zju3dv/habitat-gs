...
inline JsonGenericValue toJsonValue(
  ...
  addMember(obj, "normalizeGaussianQuaternion", x.normalizeGaussianQuaternion,
            allocator);
  return obj;
}
...
inline bool fromJsonValue(const JsonGenericValue& obj,
  ...
  bool normalizeGaussianQuaternion = true;
  readMember(obj, "normalizeGaussianQuaternion", normalizeGaussianQuaternion);
  x.normalizeGaussianQuaternion = normalizeGaussianQuaternion;
