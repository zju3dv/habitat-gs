...
class StageAttributes : public AbstractObjectAttributes {
 public:
  ...
  void setGaussianNormalizeQuaternion(bool normalize) {
    set("norm_quaternion", normalize);
  }
  bool getGaussianNormalizeQuaternion() const {
    return get<bool>("norm_quaternion");
  }
