...
class SceneInstanceAttributesManager
 ...
 protected:
  ...
  /**
   * @brief Used Internally. Create a GaussianAvatarAttributes object from JSON.
   */
  attributes::GaussianAvatarAttributes::ptr
  createGaussianAvatarAttributesFromJSON(const io::JsonGenericValue& jCell);
